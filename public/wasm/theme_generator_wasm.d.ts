...
export function generate_css(theme_json: string): string;

export function generate_json(theme_json: string): string;

export function generate_sass(theme_json: string): string;
...
export interface InitOutput {
  ...
  readonly generate_css: (a: number, b: number) => [number, number];
